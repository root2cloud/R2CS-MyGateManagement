...
class TicketHelpDesk(models.Model):
    ...
    #     """Create Invoice from Helpdesk Ticket Tasks"""
    #
    #     # ---------------------------------------------------------
    #     # 1. Basic Validations
    #     # ---------------------------------------------------------
    ...
    #         raise UserError("Please select a Service Product on the ticket.")
    #
    #     if self.cost <= 0:
    #         raise UserError("Cost per hour must be greater than zero.")
    #
    #     # ---------------------------------------------------------
    #     # 2. Fetch all pending tasks linked to the ticket
    #     # ---------------------------------------------------------
    ...
    #
    #     if not tasks:
    #         raise UserError("No pending tasks found to bill.")
    #
    #     # ---------------------------------------------------------
    ...
    #         for task in tasks
    #         if task.effective_hours > 0 and not task.is_invoiced
    #     )
    #
    #     if total_hours <= 0:
    #         raise UserError("No billable hours available for invoicing.")
    #
    #     # ---------------------------------------------------------
    ...
    #                 'name': f"{self.service_product_id.name} (Support Hours)",
    ...
    #
    #     # ---------------------------------------------------------
    #     # 6. Mark Tasks as Billed
    #     # ---------------------------------------------------------
    #     for task in tasks:
    #         task.ticket_billed = True
    #         task.is_invoiced = True  # Optional but helpful for accounting status
    #
    #     # ---------------------------------------------------------
    ...
    def action_create_invoice(self):
        ...
        total = sum(
            x.effective_hours for x in tasks
            if x.effective_hours > 0 and not x.is_invoiced
        )
